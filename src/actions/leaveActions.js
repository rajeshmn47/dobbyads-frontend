...
export const createimage = (myform) => async (dispatch) => {
  try {
    ...
    const data = await axios({
      method: "POST",
      url: "https://vouch-digital-backend.herokuapp.com/image/createimage",
      data: myform,
      headers: {
        ...headers,
        "Content-Type": "application/json",
...
export const getleaves = (myform) => async (dispatch) => {
  try {
    ...
    const data = await axios({
      method: "get",
      url: "https://vouch-digital-backend.herokuapp.com/image/getallclients",
      data: myform,
      headers: {
        ...headers,
        "Content-Type": "application/json",
...
export const editleave = (myform) => async (dispatch) => {
  try {
    ...
    const data = await axios({
      method: "post",
      url: `https://vouch-digital-backend.herokuapp.com/image/editimage`,
      data: {
        name: myform.name,
        image: myform.image,
        _id: myform._id,
...
export const deleteleave = (id) => async (dispatch) => {
  try {
    ...
    const data = await axios({
      method: "get",
      url: `https://vouch-digital-backend.herokuapp.com/image/deleteimage/${id}`,
      headers: {
        ...headers,
        "Content-Type": "application/json",
        Authorization: `Bearer ${access_token}`,
